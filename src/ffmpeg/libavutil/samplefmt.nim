...
proc av_samples_alloc_array_and_samples* (audio_data: ptr ptr uint8, linesize: ptr cint, nb_channels: cint, nb_samples: cint, sample_fmt: AVSampleFormat, align: cint): cint
